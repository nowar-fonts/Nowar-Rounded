...
def NameFont(font, region, weight, version):
	...
	font['name'] = [
		...
		},
		{
			...
			"languageID": 1033,
			"nameID": 1,
			"nameString": "Nowar Compact Rounded {}".format(region) if isStdStyle else "Nowar Compact Rounded {} {}".format(region, weight)
		},
		{
			"platformID": 3,
			"encodingID": 1,
			"languageID": 2052,
			"nameID": 1,
			"nameString": "有爱窄圆体 {}".format(region) if isStdStyle else "有爱窄圆体 {} {}".format(region, weight)
		},
		{
			"platformID": 3,
			"encodingID": 1,
			"languageID": 1028,
			"nameID": 1,
			"nameString": "有愛窄圓體 {}".format(region) if isStdStyle else "有愛窄圓體 {} {}".format(region, weight)
		},
		{
			"platformID": 3,
			"encodingID": 1,
		...
		},
		{
			...
			"languageID": 1033,
			"nameID": 3,
			"nameString": "Nowar Compact Rounded {} {}".format(region, weight) + ' ' + str(version)
		},
		{
			"platformID": 3,
			"encodingID": 1,
			"languageID": 1033,
			"nameID": 4,
			"nameString": "Nowar Compact Rounded {} {}".format(region, weight)
		},
		{
			"platformID": 3,
			"encodingID": 1,
			"languageID": 2052,
			"nameID": 4,
			"nameString": "有爱窄圆体 {} {}".format(region, weight)
		},
		{
			"platformID": 3,
			"encodingID": 1,
			"languageID": 1028,
			"nameID": 4,
			"nameString": "有愛窄圓體 {} {}".format(region, weight)
		},
		{
			"platformID": 3,
			"encodingID": 1,
		...
		},
		{
			...
			"languageID": 1033,
			"nameID": 6,
			"nameString": "Nowar-Compact-Rounded-{}-{}".format(region, weight.replace(' ', '-'))
		},
		{
			"platformID": 3,
			"encodingID": 1,
		...
		},
		{
			...
			"languageID": 1033,
			"nameID": 16,
			"nameString": "Nowar Compact Rounded {}".format(region)
		},
		{
			"platformID": 3,
			"encodingID": 1,
			"languageID": 2052,
			"nameID": 16,
			"nameString": "有爱窄圆体 {}".format(region)
		},
		{
			"platformID": 3,
			"encodingID": 1,
			"languageID": 1028,
			"nameID": 16,
			"nameString": "有愛窄圓體 {}".format(region)
		},
		{
			"platformID": 3,
			"encodingID": 1,
...
if __name__ == '__main__':
	...
	with open("nowar/{}-NowarCompactRounded-{}-{}.otd".format(encoding, region, weight), 'w') as outFile:
