...
def NameFont(font, region, weight, version):
	...
	font['name'] = [
		...
		},
		{
			...
			"languageID": 1033,
			"nameID": 1,
			"nameString": "Nowar Wide Rounded UI {}".format(region) if isStdStyle else "Nowar Wide Rounded UI {} {}".format(region, weight)
		},
		{
			"platformID": 3,
			"encodingID": 1,
			"languageID": 2052,
			"nameID": 1,
			"nameString": "有爱宽圆体 UI {}".format(region) if isStdStyle else "有爱宽圆体 UI {} {}".format(region, weight)
		},
		{
			"platformID": 3,
			"encodingID": 1,
			"languageID": 1028,
			"nameID": 1,
			"nameString": "有愛寬圓體 UI {}".format(region) if isStdStyle else "有愛寬圓體 UI {} {}".format(region, weight)
		},
		{
			"platformID": 3,
			"encodingID": 1,
		...
		},
		{
			...
			"languageID": 1033,
			"nameID": 3,
			"nameString": "Nowar Wide Rounded UI {} {}".format(region, weight) + ' ' + str(version)
		},
		{
			"platformID": 3,
			"encodingID": 1,
			"languageID": 1033,
			"nameID": 4,
			"nameString": "Nowar Wide Rounded UI {} {}".format(region, weight)
		},
		{
			"platformID": 3,
			"encodingID": 1,
			"languageID": 2052,
			"nameID": 4,
			"nameString": "有爱宽圆体 UI {} {}".format(region, weight)
		},
		{
			"platformID": 3,
			"encodingID": 1,
			"languageID": 1028,
			"nameID": 4,
			"nameString": "有愛寬圓體 UI {} {}".format(region, weight)
		},
		{
			"platformID": 3,
			"encodingID": 1,
		...
		},
		{
			...
			"languageID": 1033,
			"nameID": 6,
			"nameString": "Nowar-Wide-Rounded-UI-{}-{}".format(region, weight.replace(' ', '-'))
		},
		{
			"platformID": 3,
			"encodingID": 1,
		...
		},
		{
			...
			"languageID": 1033,
			"nameID": 16,
			"nameString": "Nowar Wide Rounded UI {}".format(region)
		},
		{
			"platformID": 3,
			"encodingID": 1,
			"languageID": 2052,
			"nameID": 16,
			"nameString": "有爱宽圆体 UI {}".format(region)
		},
		{
			"platformID": 3,
			"encodingID": 1,
			"languageID": 1028,
			"nameID": 16,
			"nameString": "有愛寬圓體 UI {}".format(region)
		},
		{
			"platformID": 3,
			"encodingID": 1,
...
if __name__ == '__main__':
	...
	with open("noto/{}/NotoRounded{}-{}.otd".format('osf' if isOldstyle else 'rounded', 'OSF' if isOldstyle else '', weight), 'rb') as baseFile:
