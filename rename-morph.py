...
def NameFont(font, weight, version):
	...
	font['name'] = [
		...
		},
		{
			...
			"languageID": 1033,
			"nameID": 1,
			"nameString": "Nowar Compact Rounded" if isStdStyle else "Nowar Compact Rounded " + weight
		},
		{
			"platformID": 3,
			"encodingID": 1,
			"languageID": 2052,
			"nameID": 1,
			"nameString": "有爱窄圆体" if isStdStyle else "有爱窄圆体 " + weight
		},
		{
			"platformID": 3,
			"encodingID": 1,
			"languageID": 1028,
			"nameID": 1,
			"nameString": "有愛窄圓體" if isStdStyle else "有愛窄圓體 " + weight
		},
		{
			"platformID": 3,
			"encodingID": 1,
		...
		},
		{
			...
			"languageID": 1033,
			"nameID": 3,
			"nameString": "Nowar Compact Rounded " + weight + ' ' + str(version)
		},
		{
			"platformID": 3,
			"encodingID": 1,
			"languageID": 1033,
			"nameID": 4,
			"nameString": "Nowar Compact Rounded " + weight
		},
		{
			"platformID": 3,
			"encodingID": 1,
		...
		},
		{
			...
			"languageID": 1033,
			"nameID": 6,
			"nameString": "Nowar-Compact-Rounded-" + weight.replace(' ', '-')
		},
		{
			"platformID": 3,
			"encodingID": 1,
		...
		},
		{
			...
			"languageID": 1033,
			"nameID": 16,
			"nameString": "Nowar Compact Rounded"
		},
		{
			"platformID": 3,
			"encodingID": 1,
...
if __name__ == '__main__':
	...
	with open("nowar/NowarCompactRounded-{}.otd".format(weight), 'w') as outFile:
